      ...
      <Card style={{ maxWidth: 1200, margin: "auto", 
        ...
        <CardContent>
          ...
          <Typography gutterBottom variant="h5" style={{padding: "35px"}}>
            <LooksOneIcon color="primary" fontSize="large"></LooksOneIcon> Are you updating your house address?
          </Typography>
          ...
          <form>
            ...
            <Typography gutterBottom variant="h5" style={{padding: "35px", margin: "25px"}}>
              <LooksTwoIcon color="primary" fontSize="large"></LooksTwoIcon> What about these other details?
            </Typography> 
            ...
            <Typography gutterBottom variant="h5" style={{padding: "35px", margin: "25px"}}>
              <Looks3Icon color="primary" fontSize="large"></Looks3Icon> Some final changes? 
            </Typography>
